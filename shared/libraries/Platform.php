...
class Platform
{
    ...
    private function _init($running_platform)
    {
        ...
        {
            if (file_exists(CMS_SHARE_PATH . 'config/platform.php'))
            {
               include CMS_SHARE_PATH . 'config/platform.php';
            }
        }
        ...
        if (file_exists($platform_class_path = CMS_SHARE_PATH . 'libraries/platforms/platform_' . $platform . '.php'))
        {
