        ...
        License.prototype.show = function() {
            if ( ! this.isShow)
            {
                this.$container.find('.modal-body').html(' \
                    <p><a target="_blank" href="http://cms.com">CMS</a>是开源的，面向<a target="_blank" href="http://codeigniter.org.cn">CodeIgniter</a>开发者的，自由灵活的后台系统，并致力于为开发者提供最简单，易扩展，实用的后台系统。</p> \
                    <p><a target="_blank" href="http://cms.com">CMS</a>基于<a target="_blank" href="https://github.com/CMS/CMS#license">MIT协议</a>开源, 开发者可以自由修改使用, 除以下条款: </p> \
                    <p> \
                        <ol> \
                            <li>登陆页面希望不强制保留对CMS官方网站的链接.</li> \
                            <li>FLASH上传控件版权归Discuz!所有.</li> \
                            <li>后台UI版权归iwebshop所有.</li> \
                        </ol> \
                        <span class="label label-warning">注: CMS V3.0以后将采用开源上传组件和UI框架.</span> \
                    </p> \
                    <p> \
                        本安装程序使用以下开源框架实现: \
                        <ul> \
