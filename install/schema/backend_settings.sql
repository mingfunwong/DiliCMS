...
CREATE TABLE IF NOT EXISTS `{DB_PREFIX}backend_settings` (
  ...
  `backend_title` varchar(100) DEFAULT '管理后台',
...
INSERT INTO `{DB_PREFIX}backend_settings` (`backend_theme`, `backend_lang`, `backend_root_access`, `backend_access_point`, `backend_title`, `backend_logo`, `plugin_dev_mode`) VALUES ('default', 'zh-cn', 1, '', '管理后台', 'images/logo.gif', 0)