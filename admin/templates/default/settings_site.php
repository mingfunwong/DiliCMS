	...
	<div class="content form_content">
        <?php echo form_open('setting/site?tab=site_basic'); ?>
            ...
            <table class="form_table dili_tabs" id="site_basic" style="<?php echo $current_tab == 'site_basic' ? '' : 'display:none'; ?>">
                ...
                <tr>
                    <th>站点底部：</th>
                    <td><textarea name='site_footer'  id="site_footer" style="height:300px;width:100%" data-editor="kindeditor" data-editor-mode="full" data-upload="true" data-url="<?php echo backend_url('attachment/save'); ?>"><?php echo $site->site_footer;?></textarea></td>
                </tr>
                <tr>
                    <th>站点关键字：</th>
        ...
        <?php echo form_open('setting/site?tab=site_status') ?>
			...
			<table class="form_table dili_tabs" id="site_status" style="<?php echo $current_tab == 'site_status' ? '' : 'display:none'; ?>">
                ...
                <tr>
                    <th>站点关闭原因：</th>
                    <td><textarea  name='site_close_reason' style="height:200px;width:100%" data-editor="kindeditor" data-editor-mode="full" data-upload="false"><?php echo $site->site_close_reason; ?></textarea></td>
                </tr>
                <tr>
                    <th></th>
                    <td>
        ...
        <?php echo form_open('setting/site?tab=site_terms'); ?>
            ...
            <table class="form_table dili_tabs" id="site_terms" style="<?php echo $current_tab == 'site_terms' ? '' : 'display:none'; ?>">
                ...
                <tr>
                    <th>注册协议：</th>
                    <td><textarea name='site_terms'  id="site_terms" style="height:300px;width:100%" data-editor="kindeditor" data-editor-mode="full" data-upload="false"></textarea></td>
                </tr>
                <tr>
                    <th></th>
                    <td>
