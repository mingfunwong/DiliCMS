	...
	<div class="content form_content">
        <?php echo form_open('category/add'); ?>
			<table class="form_table dili_tabs" id="site_basic" >
				...
				<tr>
					<th> 分类模型标识：</th>
					<td><?php $this->form->show('name','input',''); ?><label>*2-20位的仅包含字母数字以及下划线破折号的字符，将用作数据库表名。</label><?php echo form_error('name'); ?></td>
				</tr>
                <tr>
					<th> 分类模型名称：</th>
                ...
                <tr>
					<th> 分类模型层级：</th>
					<td><?php $this->form->show('level','input','','0'); ?><label>*分类的层级。</label><?php echo form_error('level'); ?></td>
				</tr>
                <tr>
					<th> 每页显示条数：</th>
					<td><?php $this->form->show('perpage','input','','100'); ?><label>*每页列表的的显示数目。</label><?php echo form_error('perpage'); ?></td>
				</tr>
                <tr>
					<th> 是否使用上传控件：</th>
					<td>
                    	<?php $this->form->show('hasattach','radio',array('1'=>'是','0'=>'否'),'1'); ?>
                ...
                <tr>
                    <th> 是否自动更新缓存：</th>
                    <td>
                        <?php $this->form->show('auto_update', 'radio', array('1'=>'是','0'=>'否'),'1'); ?>
