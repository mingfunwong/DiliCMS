...
<div class="headbar">
	...
	<div class="operating" style="position:relative; overflow:visible ">
        ...
        <?php endif; ?>
        <?php if (in_array($model['name'], array('addr'))) : ?>
            <style>
                #excelUpdate{position: relative;}
                #excelUpdate form, 
                #excelUpdate input[type=file]{position:absolute;width:100%;height:100%;left:0;top:0;opacity:0;}
            </style>
            <a href="javascript:void(0)" id="excelUpdate">
                <button class="operating_btn" type="button"><span class="addition">导入</span></button>
            ...
            <a href="<?php echo backend_url('excel/download','model='.$model['name']); ?>">
                <button class="operating_btn" type="button"><span class="remove">导出</span></button>
            </a>
        <?php endif ?>
    </div>
    <div class="field">
