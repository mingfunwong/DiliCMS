                 ...
                 <?php endforeach; ?>
                    <td>
                    	<?php if( $provider['next_level'] < $model['level'] ): ?>
                        	<a href="<?php echo backend_url('category_content/view/','model='.$model['name'].'&u_c_level='.$v->id); ?>">进入子分类</a>
                            <a href="<?php echo backend_url('category_content/form/','model='.$model['name'].'&u_c_level='.$v->id); ?>"><img class="operator" src="images/icon_add.gif" alt="添加" title="添加"></a>
                        <?php endif; ?>
                    	<a href="<?php echo backend_url('category_content/form/','model='.$model['name'].'&id='.$v->id); ?>"><img class="operator" src="images/icon_edit.gif" alt="修改" title="修改"></a>
                        <a class="confirm_delete" href="<?php echo backend_url('category_content/del','model='.$model['name'].'&id='.$v->id); ?>"><img class="operator" src="images/icon_del.gif" alt="删除" title="删除"></a>
